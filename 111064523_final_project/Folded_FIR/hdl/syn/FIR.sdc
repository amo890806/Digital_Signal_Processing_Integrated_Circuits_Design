...
#set_input_delay  [expr $cycle*0.5]   -clock clk [remove_from_collection [all_inputs] [get_ports clk]] -clock_fall
#set_output_delay [expr $cycle*0.5]    -clock clk [all_outputs]  -clock_fall
